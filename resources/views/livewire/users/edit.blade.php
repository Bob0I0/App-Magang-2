<div x-data="{modalIsOpen: false}">
    <button x-on:click="modalIsOpen = true" type="button" class="hover:bg-blue-200"><flux:icon.edit-icon /></button>
    <div x-cloak x-show="modalIsOpen" x-transition.opacity.duration.200ms x-trap.inert.noscroll="modalIsOpen" x-on:keydown.esc.window="modalIsOpen = false; $wire.resetForm();" x-on:click.self="modalIsOpen = false; $wire.resetForm();" class="fixed inset-0 z-30 flex items-end justify-center bg-black/20 p-4 pb-8 backdrop-blur-md sm:items-center lg:p-8" role="dialog" aria-modal="true" aria-labelledby="defaultModalTitle">
        ...
        <div x-show="modalIsOpen" x-transition:enter="transition ease-out duration-200 delay-100 motion-reduce:transition-opacity" x-transition:enter-start="opacity-0 scale-50" x-transition:enter-end="opacity-100 scale-100" class="flex w-full max-w-md flex-col overflow-hidden rounded-sm border border-neutral-300 bg-white text-neutral-600 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300">
            ...
            <div class="flex items-center justify-between border-b border-neutral-300 bg-neutral-50/60 p-4 dark:border-neutral-700 dark:bg-neutral-950/20">
                <h3 id="defaultModalTitle" class="font-semibold tracking-wide text-neutral-900 dark:text-white">Edit Pengguna</h3>
            ...
            <div class="p-4 md:p-5">
                <form wire:submit="updateacc" class="space-y-4">
                    ...
                    <!-- Confirmation -->
                    <div x-data="{ mode: 'edit_user' }" x-on:user-updated.window="modalIsOpen = false; mode = 'edit_user';">
                        <!-- CREATE BUTTON -->
                        <div
                            type="button"
                            x-show="mode === 'edit_user'"
                            x-transition
